...
use Besmer\TodoBundle\Entity\Todo;
...
class TodoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $todos = $em->getRepository('BesmerTodoBundle:Todo')->findAll();
    ...
    {
        $todo = new Todo();
        $form = $this->createForm('Besmer\TodoBundle\Form\TodoType', $todo);
    ...
    {
        $deleteForm = $this->createDeleteForm($todo);
        $editForm = $this->createForm('Besmer\TodoBundle\Form\TodoType', $todo);
